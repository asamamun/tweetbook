...
if(isset($_GET['tid'])){
    ...
    $editQ = "select * from tweets where id='".$id."' and uid='".$uid."' and deleted is NULL";
...
<div class="container">
  ...
  <div class="row mb-3">
    ...
    <a class="col-sm-4" href="deleteImage.php?tid=<?php echo $editQR['id'] ?>" title="delete image"><img class="img-fluid" src="assets/tweetimage/<?php echo $editQR['image'] ?>" alt="delete image" title="delete image">X</a>
  </div>
  <div class="row mb-3">
